...
class _HomeState extends State<Home> {
  final List<String> _carousalImage = [];
    ...
    return Scaffold(
      ...
      setState(() {
        _dotPosition = index;
          ...
          const SizedBox(height: 10,),
          DotsIndicator(dotsCount: _carousalImage.isEmpty?1:_carousalImage.length,
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Text('Top Products',style: TextStyle(color: Colors.red),),
